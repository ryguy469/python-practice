...
print('-------------------------------------')
print('Hungry Hungry Hippos Grocery Garage')
print('-------------------------------------')
print('Web: www.hungryhungryhipposgrocer.com')
print('Phone: 212-973-0080')
...
print('Total:')
print('-------------------------------------')
print('Thank You for Shopping @ Hungry Hungry Hippos')
